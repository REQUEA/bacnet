...
func (l FmtLogger) Infof(format string, args ...interface{})  { l.Base.Info(fmt.Sprintf(format, args...)) }
func (l FmtLogger) Errorf(format string, args ...interface{}) { l.Base.Error(fmt.Sprintf(format, args...)) }
func (l FmtLogger) Tracef(format string, args ...interface{}) { l.Base.Trace(fmt.Sprintf(format, args...)) }
